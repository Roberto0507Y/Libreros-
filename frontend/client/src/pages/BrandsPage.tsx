  ...
  return (
    <div className="grid gap-6">
      ...
      <EditSheetModal
        ...
        subtitle="Actualiza nombre y logo sin salir del listado de marcas."
        title="Editar marca"
      ...
      >
        <form className="grid gap-5 md:grid-cols-[minmax(0,1fr)_320px]" id="edit-brand-form" onSubmit={handleEditSubmit}>
